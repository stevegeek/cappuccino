...
- (id)NS_initWithCoder:(CPCoder)aCoder
{
    ...
    {
        _pathSeparator      = [aCoder decodeObjectForKey:@"NSPathSeparator"];
        _minColumnWidth     = [aCoder decodeIntForKey:@"NSMinColumnWidth"];
        _defaultColumnWidth = [aCoder decodeFloatForKey:@"NSPreferedColumnWidth"];
